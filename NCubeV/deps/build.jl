...
try
	...
	@warn "Conda could not install onnx==1.9.0; falling back to pip" exception=(err, catch_backtrace())
	Conda.pip("install", "onnx==1.9.0")
end
# Keep protobuf in the known-compatible range for onnx 1.9.0-generated pb2 files.
Conda.pip("install", "protobuf==3.20.3")
