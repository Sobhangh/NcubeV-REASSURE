...
class ACCEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.action_space = spaces.Box(-self.B,self.A,shape=(1,), dtype=np.float32) # acc = -,0,+
...
class ACCEnv2(gym.Env):
    ...
    def __init__(self):
        ...
        self.action_space = spaces.Box(-1, 1, shape=(1,), dtype=np.float32) # acc = -,0,+
        self.observation_space = spaces.Box(-high, high, dtype=np.float32)
    ...
    def model_reset(self):
        ...
        self.steps_beyond_done = None
        return np.array(self.state), {'polytope_reset': False}
...
if 'acc-variant-v0' not in registry:
    register(
                id='acc-variant-v0',
                entry_point=ACCEnv,
    ...
    print("Registered acc-variant-v0")

#if 'acc-variant-v1' not in registry:
register(
        id='acc-variant-v1',
        entry_point=ACCEnv2,
        max_episode_steps=410,  # todo edit
...
print("Registered acc-variant-v1")

if 'acc-variant-v2' not in registry:
    register(
                id='acc-variant-v2',
                entry_point=ACCEnv3,
                max_episode_steps=410,  # todo edit
    ...
    print("Registered acc-variant-v2")