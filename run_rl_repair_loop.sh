...
run_ncubev () {
  ...
  OPENBLAS_NUM_THREADS=1 OMP_NUM_THREADS=1 ./NCubeV/deps/NCubeV/bin/NCubeV NCubeV/test/parsing/examples/acc/formula NCubeV/test/parsing/examples/acc/fixed NCubeV/test/parsing/examples/acc/mapping retrain/${1}.onnx retrain/${2} --approx 1
}
...
for i in $(seq 1 10); do
  ...
  (
    ...
    julia acc_Ncube_polytope_convert.jl "retrain/acc_bigger_polytopes-${i}-final.jld"
